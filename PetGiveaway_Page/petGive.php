...
<head>
    <meta charset="UTF-8">
    <title>Project</title>
    <link rel="stylesheet" type="text/css" href="./CSS_petGive.css">
    <script defer>
...
<body>
    <div class="SideMenu">
        <Ul>
            ...
            <li class="active"><a href="../PetGiveaway_Page/petGive.php">Have a Pet to Give Away</a> </li>
    ...
    <div class="Container">
        ...
        <form id="dogForm" style="display:none" onsubmit=" return GiveDogVerify()">
            <fieldset>
                ...
                <label>
                    <input id="pomsky" type="checkbox" name="animalBreed[]" value="pomsky">
                    Pomsky(mix)
                </label>
                <label>
                ...
                <label>
                    <input id="dogNoneReq" type="checkbox" name="requirements[]" value="catNoneReq">
                    None
                </label> <br /><br />

                <label> Comments About Animal: <br /><textarea name="animalDescription" id="animalDesc" cols="30"
                        rows="5"> </textarea></label> <br /><br />

                <label> Owner's First Name:
                    <input id="fName" type="text" name="fName" /> </label> <br /><br />
                <label> Owner's Last Name:
                    <input id="lName" type="text" name="lName" /> </label> <br /><br />

                <label> Email:
                    <input id="email" type="email" name="emailOfUser">
                </label>
        ...
        <form id="catForm" style="display:none" onsubmit=" return GiveCatVerify()">
            <fieldset>
                ...
                <label>
                    <input id="moggie" type="checkbox" name="animalBreed[]" value="moggie">
                    Moggie(mix)
                </label>
                <label>
